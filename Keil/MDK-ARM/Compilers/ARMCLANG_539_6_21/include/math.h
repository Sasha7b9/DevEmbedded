...
#undef _ARMDEFLD2
  ...
  #ifdef _LIBCPP_NODISCARD_EXT
    #define _ARM_NODISCARD_EXT _LIBCPP_NODISCARD_EXT
  #else
    #define _ARM_NODISCARD_EXT
  #endif

  extern "C++" {
    _ARM_NODISCARD_EXT inline int (fpclassify)(double __x) { return fpclassify(__x); }
    _ARM_NODISCARD_EXT inline bool (isfinite)(double __x) { return isfinite(__x); }
    _ARM_NODISCARD_EXT inline bool (isgreater)(double __x, double __y) { return isgreater(__x, __y); }
    _ARM_NODISCARD_EXT inline bool (isgreaterequal)(double __x, double __y) { return isgreaterequal(__x, __y); }
    _ARM_NODISCARD_EXT inline bool (isinf)(double __x) { return isinf(__x); }
    _ARM_NODISCARD_EXT inline bool (isless)(double __x, double __y) { return isless(__x, __y); }
    _ARM_NODISCARD_EXT inline bool (islessequal)(double __x, double __y) { return islessequal(__x, __y); }
    _ARM_NODISCARD_EXT inline bool (islessgreater)(double __x, double __y) { return islessgreater(__x, __y); }
    _ARM_NODISCARD_EXT inline bool (isnan)(double __x) { return isnan(__x); }
    _ARM_NODISCARD_EXT inline bool (isnormal)(double __x) { return isnormal(__x); }
    _ARM_NODISCARD_EXT inline bool (isunordered)(double __x, double __y) { return isunordered(__x, __y); }
